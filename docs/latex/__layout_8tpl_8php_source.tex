...
00061                             <a \textcolor{keyword}{class}=\textcolor{stringliteral}{"dropdown-toggle"} href=\textcolor{stringliteral}{"#"} data-toggle=\textcolor{stringliteral}{"dropdown"}>Login <strong \textcolor{keyword}{class}=\textcolor{stringliteral}{
      "caret"}></strong></a>
00062                             <div \textcolor{keyword}{class}=\textcolor{stringliteral}{"dropdown-menu"} style=\textcolor{stringliteral}{"padding: 15px; padding-bottom: 0px;"}>
00063                                 
00064                                 <link href=\textcolor{stringliteral}{"css/signin.css"} rel=\textcolor{stringliteral}{"stylesheet"}>
00065         
00066                                                 <form \textcolor{keyword}{class}=\textcolor{stringliteral}{"form-signin"} method=\textcolor{stringliteral}{"post"} action=\textcolor{stringliteral}{"
      ?controller=UserSession&action=Login"}>
00067                                                 <input type=\textcolor{stringliteral}{"text"} name=\textcolor{stringliteral}{"user"} \textcolor{keyword}{class}=\textcolor{stringliteral}{"form-control"} 
      placeholder=\textcolor{stringliteral}{"Benutzername"} autofocus>
00068                                                 <input type=\textcolor{stringliteral}{"password"} name=\textcolor{stringliteral}{"pass"} \textcolor{keyword}{class}=\textcolor{stringliteral}{"form-control"} 
      placeholder=\textcolor{stringliteral}{"Passwort"}>
00069                                                 <button \textcolor{keyword}{class}=\textcolor{stringliteral}{"btn btn-primary btn-block"} type=\textcolor{stringliteral}{"submit"}>
      Anmelden</button>
00070                                                 </form>
00071         
00072                             </div>
...
00076           </ul>
00077           
00078         </div><!--/.nav-collapse -->
00079       </div>
00080     </div>
00081 
00082     <div \textcolor{keyword}{class}=\textcolor{stringliteral}{"container"}>
00083         <?php include($this->includetemplate); ?>
00084     </div> <!-- /container -->
00085 
00086 
00087     <!-- Bootstrap core JavaScript
00088     ================================================== -->
00089     <!-- Placed at the end of the document so the pages load faster -->
00090     <script src=\textcolor{stringliteral}{"js/jquery.js"}></script>
00091     <script src=\textcolor{stringliteral}{"js/bootstrap.min.js"}></script>
00092   </body>
00093 </html>
\end{DoxyCode}
