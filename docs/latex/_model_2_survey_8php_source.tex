...
00168                 
00169                 
00170                 $stmt = $this->dbh->prepare(\textcolor{stringliteral}{"INSERT INTO Survey SET Name = :name"});
00171                 $stmt->bindParam(\textcolor{stringliteral}{':name'}, $name);
00172                 
00173                 $stmt->execute();
00174 
00175                 $surveyID = $this->dbh->lastInsertId();
00176                 
00177                 $stmt = $this->dbh->prepare(\textcolor{stringliteral}{"INSERT INTO SurveyItems SET Name = :name, SurveyID = :id"});
00178                 
00179                 $stmt->bindParam(\textcolor{stringliteral}{':id'}, $surveyID);
00180 
00181                 \textcolor{keywordflow}{foreach} ($answerArr as $answer) \{
00182 
00183                         $stmt->bindParam(\textcolor{stringliteral}{':name'}, $answer);
00184                         $stmt->execute();
00185                         
00186                 \}
00187                 
...
00192 \textcolor{comment}{         * Anzahl der Tupel zurückgeben}
00193 \textcolor{comment}{         * }
00194 \textcolor{comment}{         * @param       String  $table  Tabellenname}
00195 \textcolor{comment}{         * }
00196 \textcolor{comment}{         * @return      Integer Anzahl der Tupel}
00197 \textcolor{comment}{         * }
00198 \textcolor{comment}{         */}
\hypertarget{_model_2_survey_8php_source_l00199}{}\hyperlink{class_model_1_1_survey_a5c2c5d322a7ae1786acb783f472cc074}{00199}         \textcolor{keyword}{private} \textcolor{keyword}{function} \hyperlink{class_model_1_1_survey_a5c2c5d322a7ae1786acb783f472cc074}{getTableCount}($table) \{
00200                 
00201                 
00202                 \textcolor{keywordflow}{switch} ($table) \{
00203                         
00204                         \textcolor{keywordflow}{case} \textcolor{stringliteral}{"User"}:
00205                         \textcolor{keywordflow}{case} \textcolor{stringliteral}{"Survey"}:
00206                         \textcolor{keywordflow}{case} \textcolor{stringliteral}{"SurveyItems"}:     
00207                         \textcolor{keywordflow}{case} \textcolor{stringliteral}{"SurveyAnswer"}:
00208                                 $stmt = $this->dbh->query(\textcolor{stringliteral}{"SELECT COUNT(*) AS cnt FROM $table"});
00209                                 \textcolor{keywordflow}{return} $stmt->fetchObject()->cnt;       
00210                                 \textcolor{keywordflow}{break};  
00211                         \textcolor{keywordflow}{default}:
00212                                 \textcolor{keywordflow}{throw} new \(\backslash\)Exception(\textcolor{stringliteral}{"Illegaler Tabellenname $table"});
00213                                 
00214                 \}
00215                                 
00216         \}
