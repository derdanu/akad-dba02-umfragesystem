...
00064                                            \{
00065 
00066                 \textcolor{keywordflow}{if} ($this->survey > 0 && $\_GET[\textcolor{stringliteral}{'action'}] == \textcolor{stringliteral}{'Save'}) \{
00067                 
00068                         $answerArr = $\_POST[\textcolor{stringliteral}{'answer'}];
00069                         
00070                         $this->model->saveNewAnswers($answerArr);
00071                         
00072                         $this->\hyperlink{class_controller_1_1_survey_a623581300b3866aaad9ed74511913544}{showSurveyResult}();
00073                         
00074                 \} \textcolor{keywordflow}{else} \{
00075                         
00076                         \textcolor{comment}{//Exception werfen}
00077                         
00078                 \}       
00079                 
00080                                 
...
Definiert in Zeile \hyperlink{_controller_2_survey_8php_source_l00090}{90} der Datei \hyperlink{_controller_2_survey_8php_source}{Controller/\-Survey.\-php}.


\begin{DoxyCode}
00090                                       \{
00091                 
00092                 \textcolor{keywordflow}{if} ($this->survey == 0) \textcolor{keywordflow}{throw} new \(\backslash\)Exception(\textcolor{stringliteral}{"Illegaler Aufruf"});
00093                 
00094                 \hyperlink{class_session_a49f0fb7185ab07bdbf6bdff477b43ff8}{\(\backslash\)Session::isUserAuthedCheck}();
00095                 
00096                 $this->\hyperlink{class_controller_1_1_survey_a623581300b3866aaad9ed74511913544}{showSurveyResult}();
00097                 
00098         \}
\end{DoxyCode}
...
Definiert in Zeile \hyperlink{_controller_2_survey_8php_source_l00105}{105} der Datei \hyperlink{_controller_2_survey_8php_source}{Controller/\-Survey.\-php}.


\begin{DoxyCode}
00105                                             \{
00106                 
00107                 $this->view->setTemplate(\textcolor{stringliteral}{'survey\_result'});
00108                 $this->view->assign(\textcolor{stringliteral}{'survey\_name'}, $this->model->getSurveyName($this->survey));
00109                 $this->view->assign(\textcolor{stringliteral}{'survey\_cnt'}, $this->model->getSurveyItemCount($this->survey));
00110                 $this->view->assign(\textcolor{stringliteral}{'survey\_result'}, $this->model->getSurveyResult($this->survey));
00111                 $this->view->display();
00112                 
00113         \}               
\end{DoxyCode}
